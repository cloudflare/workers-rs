...
mod fetcher;
mod flagship;
// Generated by `chomp build:types:flagship` from types/flagship.d.ts. Same
// allow-list as `email`: ts-gen owns the file, so suppress the lints it
// can't avoid emitting.
#[allow(
    unused_imports,
    dead_code,
    missing_debug_implementations,
