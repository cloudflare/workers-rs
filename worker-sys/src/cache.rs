...
extern "C" {
    ...
    #[wasm_bindgen(structural, method, js_class=Cache, js_name = put)]
    pub fn put_url(this: &Cache, url: String, response: Response) -> ::js_sys::Promise;
    ...
    #[wasm_bindgen(structural, method, js_class=Cache, js_name=match)]
    pub fn match_url(this: &Cache, url: String, options: JsValue) -> ::js_sys::Promise;
    ...
    #[wasm_bindgen(structural, method, js_class=Cache, js_name=delete)]
    pub fn delete_url(this: &Cache, request: String, options: JsValue) -> ::js_sys::Promise;
}
